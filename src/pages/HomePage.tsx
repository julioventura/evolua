      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center">
          ...
          {user ? (
            ...
            <div className="space-x-4">
              <Link
                to="/register"
                className="inline-flex items-center px-6 py-3 border border-gray-500 text-base font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 transition-colors"
              >
                Começar Agora
              </Link>
              <Link
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center p-6">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Avaliação Simplificada</h3>
          ...
          <div className="text-center p-6">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Gestão de Turmas</h3>
            <p className="text-gray-600">
