...
const ChatbotModal = () => {
  ...
  const getPageContext = useCallback(() => {
    ...
    switch (location.pathname) {
      case '/':
        return 'página inicial do e-volua';
      case '/terms':
        return 'página de Termos de Uso do e-volua';
      case '/privacy':
        return 'página de Política de Privacidade do e-volua';
      case '/license':
        return 'página de Licença MIT do e-volua';
      case '/login':
        return 'página de Login do e-volua';
      case '/register':
        return 'página de Cadastro do e-volua';
      case '/dashboard':
        return 'página de Dashboard do e-volua';
      case '/turmas':
        return 'página de Turmas do e-volua';
      default:
        return 'uma página do e-volua';
    }
  }, [location.pathname]);
  ...
  const getInitialMessage = useCallback(() => {
    ...
    return `Olá! 👋 Bem-vindo à ${pageContext}. Sou o seu assistente de IA e estou aqui para ajudar você!`;
  }, [getPageContext]);
  ...
  const getBotResponseLocal = (userMessage: string): string => {
    ...
    if (location.pathname === '/') {
      if (userMessage.toLowerCase().includes('aplicação') || userMessage.toLowerCase().includes('app')) {
        return 'Aqui no e-volua temos várias aplicações disponíveis: Calendar Monitor, Gmail Monitor, Fastbot e WhatsApp Monitor. Todas são gratuitas e de código aberto! Qual te interessa?';
      }
    ...
    const responses = [
      ...
      'Sou o assistente do e-volua! Posso esclarecer dúvidas sobre nossas aplicações e serviços.',
